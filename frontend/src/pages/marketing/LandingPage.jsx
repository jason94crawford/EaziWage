...
const steps = [
  ...
  },
  {
    ...
    description: 'Withdraw up to 50% of your earned wages anytime. Funds hit your M-PESA or bank account in seconds.',
    icon: Wallet
  }
];
...
const countries = [
  { name: 'Kenya', flag: '🇰🇪', providers: ['M-PESA', 'Airtel Money'], users: '25,000+', currency: 'KES' },
